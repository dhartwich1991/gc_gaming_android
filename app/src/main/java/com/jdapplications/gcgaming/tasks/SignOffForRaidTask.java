 ...
 */
public class SignOffForRaidTask extends AsyncTask<String, String, String> {
    private OnAsyncResultListener listener;
    Exception error = null;

    public SignOffForRaidTask(OnAsyncResultListener listener) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            HttpPost postRequest = new HttpPost("http://api.dotards.net:3000/api/v1/raids/sign_off");
