 ...
 */
public class IsSignedUpTask extends AsyncTask<String, String, String> {
    private OnAsyncResultListener listener;
    Exception error = null;

    public IsSignedUpTask(OnAsyncResultListener listener) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            HttpPost postRequest = new HttpPost("http://api.dotards.net:3000/api/v1/raids/signedup");
